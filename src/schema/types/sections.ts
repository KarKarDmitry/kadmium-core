...
export interface Block_OPT
    extends BaseSection_OPT, SectionHandler, FieldHandler, ActionHandler {
    type: 'block';
...
export interface Grid_OPT
    extends BaseSection_OPT, SectionHandler, FieldHandler {
    type: 'grid';
    columns?: number;
