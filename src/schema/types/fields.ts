...
export type DateTimeValue =
    | string // ISO
    | number // timestamp
    | { date: string; time: string }; // split

// Configuration for the date and time parts of a datetime field
...
export interface Ref_OPT extends Base_OPT<string | number> {
    type: 'ref';
    ref: string;
    alias?: string; // <-- Новое свойство для явного контроля имени
    relation?: {
