 ...
 */
export type RouteHandler<T extends AnyModel> = (ctx: ControllerContext<T>) => Promise<any> | any;
/**
 * Middleware function that runs before or after a route handler.
 */
export type RouteMiddleware<T extends AnyModel> = (ctx: ControllerContext<T>) => Promise<void> | void;
