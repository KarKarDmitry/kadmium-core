 ...
 */
export type FeatureBeforeHook<T extends AnyModel> = (ctx: HookContext<T>) => void | Promise<void>;
/**
 * Хук-функция (after-операции).
 */
export type FeatureAfterHook<T extends AnyModel> = (result: any, ctx: HookContext<T>) => void | Promise<void>;
/**
 * Все хуки фичи.
 *
 ...
 */
export declare abstract class KadmiumFeature<TModel extends FeatureModel = any> {
    protected core: SchemaCore;
    constructor(core: SchemaCore);
    /**
