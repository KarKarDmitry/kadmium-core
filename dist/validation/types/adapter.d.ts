...
export interface ValidationAdapter<TSchema = any> {
     ...
     */
    validateField(field: string, value: unknown): ValidationResult | Promise<ValidationResult>;
    /**
     ...
     */
    validateValStruct?(fields: ValField[], data: unknown): ValidationResult | Promise<ValidationResult>;
}
