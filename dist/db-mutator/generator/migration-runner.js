    ...
    async executeOp(op) {
        switch (op.type) {
            ...
            case "alter-type":
                ...
                break;
            case "alter-nullable":
                await this.ddl.alterNullable(op.table, op.columnName, op.newNullable);
                break;
            case "alter-default":
                await this.ddl.alterDefault(op.table, op.columnName, op.newDefault);
                break;
            case "add-index":
