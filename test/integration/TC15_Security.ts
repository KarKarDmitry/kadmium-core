...
export class TC15_Security extends IntegrationTestCase {
    ...
    protected async runImpl(): Promise<void> {
        ...
        console.log(
            '   - PASSED: 15.1 SQL injection via values (parameterized)',
        );
        ...
        await userRepo
            ...
            .go();
        console.log(
            '   - PASSED: 15.2 SQL injection via ILIKE (parameterized)',
        );
        ...
        await postRepo
            ...
            .go();
        console.log(
            '   - PASSED: 15.3 SQL injection via subquery (parameterized)',
        );
        ...
        // ========================================
        console.log(
            '   - Testing password field exclusion from default select...',
        );
        ...
        // ========================================
        console.log(
            '   - Testing DELETE without WHERE (intentional danger)...',
        );
        ...
        await userRepo
            ...
            .go();
        console.log(
            '   - PASSED: 15.13 Nested group injection (parameterized)',
        );
        ...
        if (userWithPosts?.posts && userWithPosts.posts.length > 0) {
            throw new Error(
                'Malicious where in include should return empty posts',
            );
        }
        console.log(
            '   - PASSED: 15.14 Include relation boundary (parameterized)',
        );
