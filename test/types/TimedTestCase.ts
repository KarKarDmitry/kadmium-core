...
export abstract class TimedTestCase extends TestCase {
     ...
     *   });
     *
     * @param label Название участка для логирования
     ...
     * Вызывать после run() для форматированного вывода.
     */
    ...
    /**
     * Очищает накопленные замеры (для переиспользования).
     */
